...
class AtomSophyShell:
    ...
    def load_file(self, filename, new=False, force_disk=False, hidden=False, translate=False):
        if new:
            self.current_file = ""
        ...
        if translate:
            self.current_file = self.auto_translate(self.current_file)
